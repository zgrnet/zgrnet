...
- [ ] 统一 Rust 线协议到 `protocol(1B) + service(varint) + data`
...
- [ ] 统一 Zig 线协议到 `protocol(1B) + service(varint) + data`
...
- [ ] Rust 替换旧 Mux，实现 yamux over per-service KCP
